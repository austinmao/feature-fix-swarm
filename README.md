...
You need macOS or Linux, Git, Bash or zsh, Node.js 24+ with npm 10+, Python
...
- Ubuntu with Bash
- Codex CLI `>=0.137.0,<0.148.0` or exact `0.154.0` / `0.155.1` / `0.156.1` (`0.146.x`, `0.147.x`, `0.154.0`, `0.155.1`, and `0.156.1` are tested; intervening and other later releases are refused)
