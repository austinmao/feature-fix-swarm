...
| --- | --- | --- | --- |
| Claude Code or Codex CLI | At least one current supported host; Codex `>=0.137.0,<0.148.0` or exact `0.154.0` / `0.155.1` / `0.156.1` / `0.157.0` | User-installed | Runs the skills and agents |
