...
| Codex CLI | `>=0.137.0,<0.148.0` or exact `0.154.0` / `0.155.1` / `0.156.1` / `0.157.0` | Tested on `0.146.x`, `0.147.x`, `0.154.0`, `0.155.1`, `0.156.1`, and `0.157.0`; doctor and `gsd-run` refuse intervening and other later releases |
